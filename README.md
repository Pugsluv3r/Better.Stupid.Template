...
I have modified this template to be more user-friendly and easier to understand, but it still requires some knowledge of C# and Unity(recomended). If you're new to modding or programming, It can be difficult to understand
